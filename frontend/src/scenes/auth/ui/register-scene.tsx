      ...
      <div className="grid w-full max-w-5xl items-center gap-12 lg:grid-cols-[1fr_1fr]">
        <div className="order-2 space-y-6 lg:order-1">
          ...
          <p className="text-lg text-neutral-600 dark:text-slate-300">
            A CaseCellShop mantém seu cadastro seguro e pronto para testar o fluxo completo de checkout sem depender do ERP.
          </p>
          <div className="grid gap-4 md:grid-cols-2">
            <div className="rounded-3xl border border-neutral-200 bg-white/90 p-5 shadow-sm transition-colors dark:border-neutral-700 dark:bg-neutral-900/60">
              <h2 className="font-display text-lg text-neutral-900 dark:text-slate-100">Senhas fortes</h2>
              <p className="mt-2 text-sm text-neutral-600 dark:text-slate-300">Validação automática garante padrões de segurança com feedback imediato.</p>
            </div>
            <div className="rounded-3xl border border-neutral-200 bg-white/90 p-5 shadow-sm transition-colors dark:border-neutral-700 dark:bg-neutral-900/60">
              <h2 className="font-display text-lg text-neutral-900 dark:text-slate-100">RBAC completo</h2>
              <p className="mt-2 text-sm text-neutral-600 dark:text-slate-300">Utilize contas admin para gerenciar produtos e clientes para finalizar pedidos.</p>
            </div>
          </div>
        </div>
